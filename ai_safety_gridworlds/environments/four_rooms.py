...
"""The classical four rooms environment.
"""
...
class FourRoomEnvironment(safety_game.SafetyEnvironment):
  """Python environment for the boat race environment."""

  def __init__(self):
    """Builds a `FourRoomEnvironment` python environment.
    ...
    self.set_goal(np.array([7,8]))

    super(FourRoomEnvironment, self).__init__(
